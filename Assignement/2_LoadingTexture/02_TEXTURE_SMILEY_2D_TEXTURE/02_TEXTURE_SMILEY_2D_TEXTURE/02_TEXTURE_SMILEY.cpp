...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SIZE:
		smiley.resize(LOWORD(lParam), HIWORD(lParam));
		break;
...
void MySmiley::ToggleFullScreen(void)
{
	MONITORINFO mi;
...
void MySmiley::initialize(void)
{
	...
	smiley.LoadGLTextures(&gTextureSmiley, MAKEINTRESOURCE(IDBITMAP_SMILEY));
	gPerspectiveProjectionMatrix = mat4::identity();

	smiley.resize(WIN_WIDTH, WIN_HEIGHT);
...
int MySmiley::LoadGLTextures(GLuint * texture, TCHAR imageResourceID[])
{
...
void MySmiley::resize(int width, int height)
{
	if (height == 0)
		height = 1;
...
void MySmiley::uninitialize(void)
{
